...
Файл `PostProcessing` предназначен сравнения траекторий цели заданной функцией `Trajectory`
...
опорного сигнала и спаду другого сигнала, что представлено на ***рисунке 2*** 
